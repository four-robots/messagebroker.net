# MessageBroker.Core.Tests

Unit tests for the MessageBroker.Core library.

## Overview

This project contains comprehensive unit tests for the MessageBroker.Core library using xUnit.
...
dotnet test src/MessageBroker.Core.Tests/MessageBroker.Core.Tests.csproj

# Run with verbose output
dotnet test src/MessageBroker.Core.Tests/MessageBroker.Core.Tests.csproj --verbosity detailed

# Run with code coverage
dotnet test src/MessageBroker.Core.Tests/MessageBroker.Core.Tests.csproj --collect:"XPlat Code Coverage"
```
