        ...
        try
        {
            ...
            if (File.Exists(tasksJsonPath))
            {
                ...
                if (!existingStreams.Contains("TASKS"))
                {
                    ...
                    Console.WriteLine($"   ✓ Stream created: {info.Config.Name}");
                    Console.WriteLine($"   ✓ Description: {info.Config.Description}");
                    Console.WriteLine($"   ✓ Max Messages: {info.Config.MaxMsgs:N0} (modified)");
