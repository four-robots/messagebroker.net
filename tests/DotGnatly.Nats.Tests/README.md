# DotGnatly.Nats.Tests

Unit tests for the DotGnatly.Nats library.

## Overview

This project contains unit tests for the DotGnatly.Nats library using xUnit.
...
dotnet test src/DotGnatly.Nats.Tests/DotGnatly.Nats.Tests.csproj --verbosity detailed

# Run with code coverage
dotnet test src/DotGnatly.Nats.Tests/DotGnatly.Nats.Tests.csproj --collect:"XPlat Code Coverage"
```
...
- DotGnatly.Nats (project reference)
